 ...
 */
class Install_item extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->db->table_exists('checklist_item')) {
            $this->validation_lib->respondError('Table sudah tersedia!');
        } else {
            //        bikin query untuk create table - TO DO dan alter table
            $queryCreateTable = "CREATE TABLE `checklist_item` (
              `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
              `id_checklist` varchar(200) NOT NULL,
