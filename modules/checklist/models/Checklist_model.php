...
class checklist_model extends CI_Model
{
    ...
    {
        return $this->db->get_where("checklist", array("id" => $id, "deleted_at" => null))->row(0);
    }
     ...
     * @return mixed
     */
    public function all($filters = array(), $offset, $limit)
    {
        ...
        return $this->db->get_where("checklist", $filters)->result();
    }
